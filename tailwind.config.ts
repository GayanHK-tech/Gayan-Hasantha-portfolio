	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Cinematic space theme colors
				charcoal: 'hsl(var(--charcoal))',
				'charcoal-light': 'hsl(var(--charcoal-light))',
				'cinematic-blue': 'hsl(var(--cinematic-blue))',
				'electric-blue': 'hsl(var(--electric-blue))',
				'deep-space': 'hsl(var(--deep-space))',
				'meteor-orange': 'hsl(var(--meteor-orange))',
				'thunder-white': 'hsl(var(--thunder-white))',
				sidebar: {
			...
			animation: {
				...
				'aurora-flow': 'aurora-flow 4s ease-in-out infinite',
				'orbit': 'orbit 20s linear infinite',
				'twinkle': 'twinkle 2s ease-in-out infinite',
				'meteor-fall': 'meteor-fall 3s linear infinite',
				'star-flash': 'star-flash 2s ease-in-out infinite',
				'lightning-flash': 'lightning-flash 4s ease-in-out infinite',
				'thunder-crack': 'thunder-crack 2s ease-in-out infinite'
			}
		}
	},
